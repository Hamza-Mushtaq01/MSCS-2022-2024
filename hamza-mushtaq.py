...
Original file is located at
    https://colab.research.google.com/drive/1fu2R5e32T0I9U9fLrnDYE0UeEZ8FCCho
...
hamza_guests = ["saad", "farhan", "Ali"];
print("Hi "+hamza_guests[0]+", "+hamza_guests[1]+", "+hamza_guests[2]+", You all are invited for Dinner at Tasty on coming Sunday.")
...
hamza_guests = ["latif", "saqib", "Ali"];
print(hamza_guests[1]+" Will not be able to join us for Dinner.")

hamza_guests[1] = 'zubi';
print("Hi "+hamza_guests[0]+", You are invited for Dinner at tasty on coming Sunday.")
print("Hi "+hamza_guests[1]+", You are invited for Dinner at tasty on coming Sunday.")
print("Hi "+hamza_guests[2]+", You are invited for Dinner at tasty on coming Sunday.")
...
hamza_guests = ["latif", "saqib", "Ali"];
hamza_guests.insert(0, "zubi");
hamza_guests.insert(2, "abu");
...
removed3 = hamza_guests.pop(0)
print("Hi "+removed3+", Sorry I can't invite you to dinner")
removed4 = hamza_guests.pop(0)
print("Hi "+removed4+", Sorry I can't invite you to dinner\n")
print("Hi "+hamza_guests[0]+", You are still invited for the Dinner")
print("Hi "+hamza_guests[1]+", You are still invited for the Dinner")
